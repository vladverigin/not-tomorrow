...
import {UserCredentials} from 'stores/userStore/models';

const userStore = useUserStore()

const email = ref<string>('dasdasdas');
...
<template>
  <q-page class="flex flex-center bg-grey-2">
    <q-card class="q-pa-md shadow-2 my_card" bordered>
      ...
      <q-card-section>
        <q-btn color="dark" rounded size="md" label="Sign in" no-caps class="full-width" @click="login"></q-btn>
      </q-card-section>
